...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'TradeTransaction', fields ['read_only']
        db.create_index('trade_tradetransaction', ['read_only'])

        # Adding index on 'TradeTransaction', fields ['success']
        db.create_index('trade_tradetransaction', ['success'])

        # Adding index on 'TradeTransaction', fields ['is_won']
        db.create_index('trade_tradetransaction', ['is_won'])

        # Adding index on 'TradeTransaction', fields ['close_price']
        db.create_index('trade_tradetransaction', ['close_price'])

        # Adding index on 'TradeTransaction', fields ['is_demo']
        db.create_index('trade_tradetransaction', ['is_demo'])


    def backwards(self, orm):
        # Removing index on 'TradeTransaction', fields ['is_demo']
        db.delete_index('trade_tradetransaction', ['is_demo'])

        # Removing index on 'TradeTransaction', fields ['close_price']
        db.delete_index('trade_tradetransaction', ['close_price'])

        # Removing index on 'TradeTransaction', fields ['is_won']
        db.delete_index('trade_tradetransaction', ['is_won'])

        # Removing index on 'TradeTransaction', fields ['success']
        db.delete_index('trade_tradetransaction', ['success'])

        # Removing index on 'TradeTransaction', fields ['read_only']
        db.delete_index('trade_tradetransaction', ['read_only'])
