...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TradeTransaction.double_trade_size'
        db.add_column('trade_tradetransaction', 'double_trade_size',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'SignalRequest.double_trade_size'
        db.add_column('trade_signalrequest', 'double_trade_size',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TradeTransaction.double_trade_size'
        db.delete_column('trade_tradetransaction', 'double_trade_size')

        # Deleting field 'SignalRequest.double_trade_size'
        db.delete_column('trade_signalrequest', 'double_trade_size')
    ...
    models = {
        ...
        'market.signal': {
            ...
            'days_trial': ('django.db.models.fields.SmallIntegerField', [], {'default': '0'}),
            'desc_full': ('django.db.models.fields.TextField', [], {}),
            'desc_short': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'double_trade_size': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
