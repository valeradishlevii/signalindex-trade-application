...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SignalRequest.is_won'
        db.add_column('trade_signalrequest', 'is_won',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SignalRequest.is_won'
        db.delete_column('trade_signalrequest', 'is_won')
