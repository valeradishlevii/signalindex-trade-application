...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SignalRequest.comment'
        db.add_column('trade_signalrequest', 'comment',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'SignalRequest.data'
        db.add_column('trade_signalrequest', 'data',
                      self.gf('jsonfield.fields.JSONField')(default={}),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SignalRequest.comment'
        db.delete_column('trade_signalrequest', 'comment')

        # Deleting field 'SignalRequest.data'
        db.delete_column('trade_signalrequest', 'data')
