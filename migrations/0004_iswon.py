...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TradeTransaction.is_won'
        db.add_column('trade_tradetransaction', 'is_won',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TradeTransaction.is_won'
        db.delete_column('trade_tradetransaction', 'is_won')
