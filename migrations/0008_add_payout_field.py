...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TradeTransaction.payout'
        db.add_column('trade_tradetransaction', 'payout',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=25, decimal_places=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TradeTransaction.payout'
        db.delete_column('trade_tradetransaction', 'payout')
    ...
    models = {
        ...
        'market.brokeruserdata': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_balance_update': ('django.db.models.fields.DateTimeField', [], {'null': 'True'}),
